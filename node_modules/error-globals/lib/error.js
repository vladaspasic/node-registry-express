...
Error.extend = function(name, proto) {
	...
	Exception.prototype.init = proto.init || noop;
	Exception.prototype.logLevel = proto.logLevel || 'error';
	Exception.prototype.statusCode = parseInt(proto.statusCode || 500, 10);
