...
function createExpressServer(project, container, environment) {
	...
	app.use('trust proxy', environment.get('server.options.proxy', false));
	app.use('etag', environment.get('server.options.etag', 'weak'));
	app.use('jsonp callback name', environment.get('server.options.jsonp-callback', 'callback'));
	app.use('query parser', environment.get('server.options.query-parser', 'extended'));
	app.use('strict routing', environment.get('server.options.strict-routing', 'false'));
	app.use('strict routing', environment.get('server.options.strict-routing', 'false'));
